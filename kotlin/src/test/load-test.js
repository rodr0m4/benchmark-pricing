...
export let options = {
    ...
    thresholds: {
        // We want the 95th percentile of all HTTP request durations to be less than 10ms
...
export default function () {
    let response = http.get("http://localhost:8080/price?user_id=1&item_ids=1,2,3");
